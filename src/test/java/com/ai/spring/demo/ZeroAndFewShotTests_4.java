...
public class ZeroAndFewShotTests_4 extends BaseTestClass {
    ...
    void zeroShotPromptTest() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            //it will return back a different answer three times. by putting a random string in there that seems to break the cache on the API.
        //So being that it's a smaller value it should give us a much more consistent result.
...
// temperature is a parameter that we can pass in. And going from memory it ranges from 0.1 from 2 to 0.1.
